        ...
        <div class="descriptions-view">
          <el-descriptions :column="1" border v-show="!isEmpty">
            ...
            <el-descriptions-item :contentStyle="{'text-align': 'center'}">
              <el-button size="medium" type="danger" @click="submitDeleteUser">删除</el-button>
...
<script>
import { getUserInfo, deleteUser } from 'network/userinfo'
  ...
  methods: {
    ...
    submitDeleteUser () {
      this.$confirm('此操作将永久删除该用户, 是否继续?', '提示', {
        ...
        deleteUser(this.userInfo.user_id, this.userInfo.user_name).then(res => {
          if (res.status === 0) {
